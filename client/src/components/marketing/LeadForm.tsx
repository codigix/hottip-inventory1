...
export default function LeadForm({ open, onOpenChange, leadId, defaultValues }: LeadFormProps) {
  ...
  const createMutation = useMutation({
    mutationFn: (data: LeadFormData) => apiRequest('/api/leads', { method: 'POST', body: JSON.stringify(data) }),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: LeadFormData) => apiRequest(`/api/leads/${leadId}`, { method: 'PUT', body: JSON.stringify(data) }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/leads'] });
