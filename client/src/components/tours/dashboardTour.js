  ...
  steps: [
    {
      ...
      text: "Welcome to Stock Management! Here you record all stock movements, track inventory levels, monitor low-stock alerts, and view transaction history. This is the core of your inventory operations.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-stock-in-button']",
      title: "Record Stock In (Receive)",
      text: "Click here to record new stock arriving from purchases, returns, or adjustments. This increases your inventory levels.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-stock-in-button']",
      title: "Stock In Form - Transaction Type",
      text: "Once you click Stock In, you'll see a form. The transaction type is automatically set to 'Stock In' - you'll receive incoming stock.",
      position: "bottom",
    ...
    },
    {
      ...
      text: "Choose which product is being received. You can search or scroll through your product list.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-quantity-input']",
      title: "Enter Quantity",
      text: "Enter the number of units being received.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-reason-select']",
      title: "Select Reason",
      text: "Specify why stock is coming in: Purchase order, Return from customer, Adjustment, etc.",
      position: "bottom",
    },
    {
    ...
    },
    {
      ...
      text: "Click to record this stock transaction. Your inventory will be updated immediately.",
      position: "top",
    },
    {
      element: "[data-tour='inventory-stock-out-button']",
      title: "Record Stock Out (Issue)",
      text: "Click here to record stock leaving your inventory for sales, damage, transfers, or adjustments.",
      position: "bottom",
    },
    {
      element: "[data-tour='stock-overview-table']",
      title: "Stock Overview Table",
      text: "View all products with current stock levels, available quantities, low-stock alerts (in red), and status indicators. Each row shows one product.",
      position: "top",
    },
    {
      element: "[data-tour='inventory-product-actions']",
      title: "Product Actions",
      text: "For each product: View full details, Edit product info (price, threshold), or Manage all transactions for that product.",
      position: "left",
    },
    {
      element: "[data-tour='inventory-refresh-button']",
      title: "Refresh Data",
      text: "Click to refresh all stock data and sync the latest inventory levels from the database.",
      position: "bottom",
    },
    {
...
export const inventoryVendorManagementTour = {
  ...
  steps: [
    {
      element: "[data-tour='inventory-vendors-header']",
      title: "Vendor Management Overview",
      text: "Manage all your suppliers and vendors in one place. Track contact details, communication history, purchase frequency, and vendor performance metrics.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-add-vendor-button']",
      title: "Add New Vendor",
      text: "Click here to add a new supplier or vendor to your database.",
      position: "bottom",
    },
    {
      element: "[data-tour='vendor-form-name']",
      title: "Vendor Company Name",
      text: "Enter the company/business name of the vendor for identification.",
      position: "bottom",
    },
    {
      element: "[data-tour='vendor-form-contact']",
      title: "Contact Person Name",
      text: "Enter the name of the primary contact person at the vendor.",
      position: "bottom",
    },
    {
      element: "[data-tour='vendor-form-email']",
      title: "Vendor Email Address",
      text: "Enter the vendor's email address for correspondence, invoices, and quotes.",
      position: "bottom",
    },
    {
      element: "[data-tour='vendor-form-phone']",
      title: "Vendor Phone Number",
      text: "Add the vendor's phone number for direct communication and urgent inquiries.",
      position: "bottom",
    },
    {
      element: "[data-tour='vendor-list-table']",
      title: "Vendor List Table",
      text: "View all your vendors with their contact details, registration status, and action options. Each row represents one vendor.",
      position: "top",
    },
    {
      element: "[data-tour='vendor-actions']",
      title: "Vendor Actions",
      text: "For each vendor: View details, Edit information, Log communications, or Delete record.",
      position: "left",
    },
    {
      element: "[data-tour='inventory-log-communication-button']",
      title: "Log Communication",
      text: "Click here to record interactions with this vendor: emails, calls, meetings, orders, or follow-ups.",
      position: "bottom",
    },
    {
      element: "[data-tour='communication-form-type']",
      title: "Select Communication Type",
      text: "Choose the type of interaction: Email, Call, Meeting, or Order.",
      position: "bottom",
    },
    {
      element: "[data-tour='communication-form-subject']",
      title: "Add Communication Subject",
      text: "Enter a brief subject line describing the communication.",
      position: "bottom",
    },
    {
      element: "[data-tour='communication-form-notes']",
      title: "Add Communication Details",
      text: "Record details of the interaction, outcomes, pricing discussed, delivery dates, or any action items.",
      position: "top",
    },
    {
      element: "[data-tour='vendor-communications-tab']",
      title: "Communication History Tab",
      text: "Click to view all communication records with this vendor. This creates a complete audit trail of your relationship.",
      position: "top",
    },
  ],
};
  ...
  steps: [
    {
      ...
      title: "Spare Parts & Fabrication Overview",
      text: "This section manages your spare parts inventory with status tracking and fabrication order workflows. Monitor part availability, create fabrication orders, and assign work to team members.",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-parts-tab']",
      title: "Spare Parts Tab - Click to View",
      text: "Click here to view and manage all spare parts in your inventory. You'll see all parts with their current status and stock levels.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-add-spare-part-button']",
      title: "Add New Spare Part",
      text: "Click to create a new spare part entry with all specifications.",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-number']",
      title: "Part Number",
      text: "Enter a unique identifier for this part (e.g., SP-001, BEARING-A).",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-name']",
      title: "Part Name",
      text: "Enter a descriptive name that identifies the spare part.",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-type']",
      title: "Part Type/Category",
      text: "Categorize the part (e.g., Bearing, Seal, Valve, Motor, Pump).",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-stock']",
      title: "Current Stock Quantity",
      text: "Enter how many units are currently in inventory.",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-minstock']",
      title: "Minimum Stock Level",
      text: "Set the threshold that triggers low-stock alerts when inventory falls below this number.",
      position: "bottom",
    },
    {
      element: "[data-tour='spare-part-form-fabricationtime']",
      title: "Fabrication Time (Hours)",
      text: "Enter the typical time in hours needed to manufacture this part if it's not in stock.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-spare-parts-table']",
      title: "Spare Parts List",
      text: "View all spare parts with status indicators: Available (green), In Fabrication (blue), Quality Check (yellow), Ready (purple), or Damaged (red). You can also see current stock and location.",
      position: "top",
    },
    {
      element: "[data-tour='inventory-fabrication-orders-tab']",
      title: "Fabrication Orders Tab - Click to View",
      text: "Click here to manage and track all fabrication orders. This is where you create work orders for part manufacturing.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-add-fabrication-order-button']",
      title: "Create New Fabrication Order",
      text: "Click to create a new fabrication order for a spare part with deadline and team assignments.",
      position: "bottom",
    },
    {
      element: "[data-tour='fab-order-form-part']",
      title: "Select Part to Fabricate",
      text: "Choose which spare part needs to be manufactured.",
      position: "bottom",
    },
    {
      element: "[data-tour='fab-order-form-quantity']",
      title: "Quantity to Fabricate",
      text: "Enter the number of units to manufacture.",
      position: "bottom",
    },
    {
      element: "[data-tour='fab-order-form-duedate']",
      title: "Set Due Date",
      text: "Set the deadline for completing this fabrication order.",
      position: "bottom",
    },
    {
      element: "[data-tour='fab-order-form-assignedto']",
      title: "Assign to Team Member",
      text: "Select which team member will handle the fabrication of this part.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-fabrication-orders-table']",
      title: "Fabrication Orders List",
      text: "Track all fabrication orders with their status (Pending, In Progress, Completed), progress percentage, and assigned personnel. Monitor deadlines and workload.",
      position: "top",
    },
  ],
};
  ...
  steps: [
    {
      ...
      title: "Batch & Barcode Management Overview",
      text: "Manage product batches with manufacture and expiry dates, track shelf-life, generate QR codes/barcodes, and scan items for traceability and quality control.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-management-tab']",
      title: "Batch Management Tab - Click to View",
      text: "Click here to create and manage all product batches in your inventory.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-create-batch-button']",
      title: "Create New Batch",
      text: "Click to create a new batch entry with product information and dates.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-number']",
      title: "Batch Number",
      text: "Enter a unique identifier for this batch (e.g., BTH-2024-001, LOT-A-001).",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-product']",
      title: "Select Product",
      text: "Choose which product this batch contains.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-quantity']",
      title: "Batch Quantity",
      text: "Enter the total quantity of product units in this batch.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-manufacture-date']",
      title: "Manufacture Date",
      text: "Set when this batch was manufactured or received. Important for batch traceability.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-expiry-date']",
      title: "Expiry Date",
      text: "Set when this batch expires. Critical for compliance and shelf-life management.",
      position: "bottom",
    },
    {
      element: "[data-tour='batch-form-location']",
      title: "Storage Location",
      text: "Enter where this batch is stored (e.g., Warehouse A, Shelf B-3, Cold Room 1).",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-batches-table']",
      title: "Batches List",
      text: "View all batches with batch number, remaining quantity, manufacture date, expiry date, location, and quality status. Expired batches are highlighted.",
      position: "top",
    },
    {
      element: "[data-tour='barcode-tab']",
      title: "Barcode Tab - Click to View",
      text: "Click here to generate QR codes/barcodes for batches and scan items during operations.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-generate-qr-button']",
      title: "Generate QR Code/Barcode",
      text: "Click to create QR codes or barcodes for your batches or products. These enable quick scanning and traceability.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-barcode-scanner']",
      title: "Scan Barcode/QR Code",
      text: "Click to activate the scanner. Use your device camera to scan barcodes/QR codes and quickly identify and track products.",
      position: "bottom",
    },
    {
      element: "[data-tour='barcodes-table']",
      title: "Barcodes List",
      text: "View all generated barcodes/QR codes with their types, linked batches/products, and generation dates. Use for audits and traceability.",
      position: "top",
    },
  ],
};
  ...
  steps: [
    {
      ...
      title: "Inventory Tasks Overview",
      text: "Manage all inventory-related tasks here. Create work items, assign to team members, set priorities and deadlines, and track task completion status.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-create-task-button']",
      title: "Create New Task",
      text: "Click here to create a new inventory task for your team.",
      position: "bottom",
    },
    {
      element: "[data-tour='task-form-title']",
      title: "Task Title",
      text: "Enter a clear, descriptive title (e.g., 'Stock count for Section A', 'Receive new shipment from vendor X').",
      position: "bottom",
    },
    {
      element: "[data-tour='task-form-description']",
      title: "Task Description",
      text: "Add detailed instructions about what needs to be done. Include any special instructions or guidelines.",
      position: "top",
    },
    {
      element: "[data-tour='task-form-assignee']",
      title: "Assign To Team Member",
      text: "Select which team member will complete this task.",
      position: "bottom",
    },
    {
      element: "[data-tour='task-form-duedate']",
      title: "Set Due Date",
      text: "Set the deadline for task completion.",
      position: "bottom",
    },
    {
      element: "[data-tour='task-form-priority']",
      title: "Priority Level",
      text: "Set priority: Low (non-urgent), Medium (standard), or High (urgent/critical).",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-tasks-table']",
      title: "Tasks List",
      text: "View all tasks with title, assigned employee, due date, priority level, and current status (Pending, In Progress, or Completed).",
      position: "top",
    },
    {
      element: "[data-tour='inventory-task-filters']",
      title: "Filter & Sort Options",
      text: "Filter tasks by status (Pending, In Progress, Completed) or by assignee to focus on specific work.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-task-actions']",
      title: "Task Action Buttons",
      text: "For each task: Update status (mark as in progress or complete), view full details, reassign to another employee, or delete the task.",
      position: "left",
    },
  ],
};
  ...
  steps: [
    {
      ...
      text: "Access comprehensive inventory reports and analytics. Generate reports on stock balance, vendor performance, reorder forecasts, and detailed inventory insights.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-reports-tabs']",
      title: "Report Tabs Navigation",
      text: "Click on the tabs below to switch between different types of reports: Stock Balance, Vendor History, Forecast, and Analytics.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-stock-balance-tab']",
      title: "Stock Balance Report - Click to View",
      text: "Click here to view current stock levels for all products with their values, movement history, and reorder status.",
      position: "right",
    },
    {
      element: "[data-tour='stock-balance-filters']",
      title: "Filter Stock Balance",
      text: "Filter the report by product category, location, or stock status to focus on specific items.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-export-stock-button']",
      title: "Export Stock Balance Report",
      text: "Click to download the stock balance report as CSV. Use for accounting, audits, or external analysis.",
      position: "left",
    },
    {
      element: "[data-tour='inventory-vendor-history-tab']",
      title: "Vendor Performance Report - Click to View",
      text: "Click here to view purchase history, order frequency, and performance metrics for all vendors.",
      position: "right",
    },
    {
      element: "[data-tour='vendor-performance-metrics']",
      title: "Vendor Metrics Display",
      text: "View key vendor metrics: on-time delivery rate, quality score, total purchases, and average lead time.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-export-vendor-button']",
      title: "Export Vendor Report",
      text: "Click to download vendor history as CSV for procurement analysis and vendor evaluation.",
      position: "left",
    },
    {
      element: "[data-tour='inventory-forecast-tab']",
      title: "Reorder Forecast - Click to View",
      text: "Click here to view AI-generated reorder recommendations based on consumption patterns and stock levels.",
      position: "right",
    },
    {
      element: "[data-tour='forecast-settings']",
      title: "Adjust Forecast Parameters",
      text: "Customize forecast accuracy by adjusting lead time, minimum stock levels, and other parameters.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-analytics-tab']",
      title: "Analytics & Insights - Click to View",
      text: "Click here to explore detailed inventory analytics including turnover rates, slow-moving items, and movement trends.",
      position: "right",
    },
    {
      element: "[data-tour='analytics-dashboard']",
      title: "Analytics Dashboard",
      text: "View key performance indicators (KPIs) and interactive charts showing inventory health, efficiency, and trends.",
      position: "top",
    },
  ],
};
  ...
  steps: [
    {
      ...
      text: "Track daily attendance, manage leave requests, monitor team availability, and ensure adequate staffing for inventory operations.",
      position: "bottom",
    },
    {
      element: "[data-tour='attendance-tab']",
      title: "Attendance Tab - Click to View",
      text: "Click here to record and view daily attendance for inventory staff members.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-mark-attendance-button']",
      title: "Mark Attendance",
      text: "Click to record attendance for a team member.",
      position: "bottom",
    },
    {
      element: "[data-tour='attendance-form-date']",
      title: "Select Attendance Date",
      text: "Choose the date for which you're marking attendance.",
      position: "bottom",
    },
    {
      element: "[data-tour='attendance-form-employee']",
      title: "Select Employee",
      text: "Choose which team member to mark attendance for.",
      position: "bottom",
    },
    {
      element: "[data-tour='attendance-form-status']",
      title: "Select Attendance Status",
      text: "Choose status: Present (worked full day), Absent (not present), Late (arrived late), Half Day (left early), or Leave (on leave).",
      position: "bottom",
    },
    {
      element: "[data-tour='attendance-form-notes']",
      title: "Add Notes (Optional)",
      text: "Add remarks or notes for this attendance entry (e.g., 'Sick leave without notice', 'Early departure approved').",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-attendance-table']",
      title: "Attendance Records Table",
      text: "View all attendance records with date, employee name, status, notes, and time entered. Each row is one attendance entry.",
      position: "top",
    },
    {
      element: "[data-tour='inventory-attendance-filters']",
      title: "Filter & Search Records",
      text: "Filter by employee name, date range, or attendance status to quickly find specific records.",
      position: "right",
    },
    {
      element: "[data-tour='leave-tab']",
      title: "Leave Requests Tab - Click to View",
      text: "Click here to manage employee leave requests and approvals.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-request-leave-button']",
      title: "Request/Create Leave",
      text: "Click to create a new leave request for a team member.",
      position: "bottom",
    },
    {
      element: "[data-tour='leave-form-employee']",
      title: "Select Employee",
      text: "Choose which employee is requesting leave.",
      position: "bottom",
    },
    {
      element: "[data-tour='leave-form-type']",
      title: "Leave Type",
      text: "Select leave type: Casual Leave, Sick Leave, Paid Leave, Unpaid Leave, Maternity Leave, etc.",
      position: "bottom",
    },
    {
      element: "[data-tour='leave-form-startdate']",
      title: "Start Date",
      text: "Set the first day of the leave period.",
      position: "bottom",
    },
    {
      element: "[data-tour='leave-form-enddate']",
      title: "End Date",
      text: "Set the last day of the leave period.",
      position: "bottom",
    },
    {
      element: "[data-tour='leave-form-reason']",
      title: "Reason for Leave",
      text: "Enter the reason for this leave request (e.g., 'Medical appointment', 'Family emergency').",
      position: "top",
    },
    {
      element: "[data-tour='inventory-leave-requests-tab']",
      title: "Leave Requests List",
      text: "View all leave requests with employee name, dates, leave type, reason, and approval status (Pending, Approved, Rejected).",
      position: "top",
    },
    {
      element: "[data-tour='leave-actions']",
      title: "Leave Action Buttons",
      text: "Approve or reject pending leave requests. You can also view details or delete processed requests.",
      position: "left",
    },
  ],
};
  ...
  steps: [
    {
      ...
      title: "Welcome to Inventory Module",
      text: "This is your complete inventory management system. You'll learn how to navigate all sections including stock management, vendors, spare parts, batch tracking, tasks, reports, and staff attendance. Let's start by exploring the dashboard.",
      position: "bottom",
    },
    {
      element: "[data-tour='inventory-dashboard']",
      title: "Dashboard Overview",
      text: "The Dashboard shows you key metrics at a glance: total products, low-stock alerts, and pending tasks. Click here to view the complete inventory overview.",
      position: "right",
    },
    {
      element: "[data-tour='inventory-stock-management']",
      title: "Stock Management - Click to Navigate",
      text: "Click here to navigate to Stock Management. This is where you'll record all stock transactions, track inventory levels, manage stock in/out operations, and monitor low-stock alerts.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Vendor Management - Click to Navigate",
      text: "Click here to navigate to Vendor Management. Manage your suppliers, track contact information, log communication history, and monitor vendor performance metrics.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Spare Parts & Fabrication - Click to Navigate",
      text: "Click here to navigate to Spare Parts management. Create and track spare parts with status indicators, manage fabrication orders with team assignments, and track progress.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Batch & Barcode Management - Click to Navigate",
      text: "Click here to navigate to Batch management. Create product batches with manufacture and expiry dates, generate QR codes/barcodes for traceability, and scan items.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Inventory Tasks - Click to Navigate",
      text: "Click here to navigate to Tasks. Create and assign inventory-related tasks to team members, set priorities and deadlines, and track task completion.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Reports & Analytics - Click to Navigate",
      text: "Click here to navigate to Reports. Generate comprehensive reports on stock balance, vendor performance, reorder forecasts, and detailed inventory analytics.",
      position: "right",
      navigation: {
    ...
    },
    {
      ...
      title: "Staff Attendance - Click to Navigate",
      text: "Click here to navigate to Attendance management. Track daily attendance, manage leave requests, and monitor team availability for operations planning.",
      position: "right",
      navigation: {
    ...
    },
    {
      element: "[data-tour='inventory-header']",
      title: "Tour Complete!",
      text: "You've completed the Inventory Module tour! You now understand the full structure and can navigate to any section to learn detailed workflows. Click on any sidebar item to explore that section in detail.",
      position: "bottom",
    },
  ],
};
...
export const dashboardTourConfig = dashboardTour;
