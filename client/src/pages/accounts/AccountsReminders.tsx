      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Automated due/overdue payment alerts
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">Reminder System</h3>
            <p className="text-muted-foreground">
              Automated payment reminder and alert functionality coming soon.
            </p>
          </div>
        </CardContent>
      </Card>
