...
app.get('/api/leads', (_req: Request, res: Response) => {
  res.json([
    { id: 1, firstName: 'Alice', lastName: 'Smith', email: 'alice@example.com', status: 'qualified', companyName: 'Acme Corp', industry: 'Retail' },
    { id: 2, firstName: 'Bob', lastName: 'Jones', email: 'bob@example.com', status: 'pending', companyName: 'Globex', industry: 'Manufacturing' },
    { id: 3, firstName: 'Charlie', lastName: 'Brown', email: 'charlie@example.com', status: 'qualified', companyName: 'Initech', industry: 'IT' }
  ]);
});
